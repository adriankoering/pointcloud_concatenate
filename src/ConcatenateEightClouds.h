...
struct ConcatenateEightClouds : public nodelet::Nodelet {
  ConcatenateEightClouds() : listener_(buffer_) {}
  virtual ~ConcatenateEightClouds() = default;
...
private:
  ...
  message_filters::Subscriber<sensor_msgs::PointCloud2> cloud7_sub_;
