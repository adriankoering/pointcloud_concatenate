...
void ConcatenateSixClouds::onInit() {
  ...
  sync_ = std::make_unique<Synchronizer>(SyncPolicy(5), cloud1_sub_,
                                         cloud2_sub_, cloud3_sub_, cloud4_sub_,
                                         cloud5_sub_, cloud6_sub_);
  sync_->registerCallback(boost::bind(&ConcatenateSixClouds::msgCallback, this,
                                      _1, _2, _3, _4, _5, _6));
}

void ConcatenateSixClouds::msgCallback(
  ...
  //     getCommonFields({cloud1->fields, cloud2->fields, cloud3->fields,
  //                      cloud4->fields, cloud5->fields, cloud6->fields});
