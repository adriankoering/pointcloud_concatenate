...
struct ConcatenateFourClouds : public nodelet::Nodelet {
  ConcatenateFourClouds() : listener_(buffer_) {}
  virtual ~ConcatenateFourClouds() = default;
...
PLUGINLIB_EXPORT_CLASS(ConcatenateFourClouds, nodelet::Nodelet)
